##Problem Statement: Create a function that takes a list of numbers and returns the smallest number in the list.
##Problem Link: https://edabit.com/challenge/ecSZ5kDBwCD3ctjE6
