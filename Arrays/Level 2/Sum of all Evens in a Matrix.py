##Problem Statement: Create a function that returns the sum of all even elements in a 2D matrix.
##Problem Link: https://edabit.com/challenge/MbPpxYWMRihFeaNPB

#Examples:
#sum_of_evens([[1, 0, 2],[5, 5, 7],[9, 4, 3]]) ➞ 6
...
def sum_of_evens(lst):
    ...
    #Return sum of all even elements in 2d Matrix
